...
<table class="table table-hover text-center">
    ...
    <tr >
        ...
        <td><a class="nav-link" href="add.php?val=1"> <i class="fas fa-plus-square fa-3x"></i> <br> </a> ADD PERSON </td>
...
<table class="table text-center">
    ...
    <?php foreach ($personnes as $pers) {?>
        <tr>
            ...
            <th><a href="deletePersonne.php?id=<?=$pers->id ?>"><i class="fa fa-trash fa-3x" aria-hidden="true"></i></a></th>
            <th><a href="modify.php?id=<?=$pers->id ?>"><i class="fas fa-user-edit fa-3x"></i></a></th>
        </tr>
    <?php } ?>
</table>
